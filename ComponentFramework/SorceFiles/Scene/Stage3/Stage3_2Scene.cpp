...
constexpr int hammerCounter_3_2 = 4;	// 叩ける上限
//--------------------------------------------------
// コンストラクタ
//--------------------------------------------------
Stage3_2Scene::Stage3_2Scene(GameManager* _gameManager)
	:SceneBase(_gameManager, "Stage3_2")
{
	Init();
}
//--------------------------------------------------
...
void Stage3_2Scene::Init()
{
	...
	gearMaxCount_ = gearCounter_3_2;	// 定数を代入
