	...
	, state_(State::title)
{
	...
	// オプションボタン・戻るボタン
	select_option_button_ = new Revolution(game_manager_, "stageselect_option", "StageSelect_Option");
	select_return_button_ = new Revolution(game_manager_, "stageselect_return","StageSelect_Return");
	...
	// オプション画面
	option_images_[0] = new Revolution(game_manager_, "option_window", "OptionWindow", 11);
	option_images_[0]->GetTransformComponent()->SetSize(1920.0f, 1080.0f);
	option_images_[1] = new Revolution(game_manager_, "option_return", "OptionReturn", 12);
	...
	option_images_[2] = new Revolution(game_manager_, "option_frame_slider", "OptionFrameSlider_TOP", 13);
	...
	option_images_[3] = new Revolution(game_manager_, "option_bgm_button", "OptionBGMButton", 14);
	...
	option_images_[4] = new Revolution(game_manager_, "option_se_button", "OptionSEButton", 14);
	...
	option_images_[5] = new Revolution(game_manager_, "option_arrow_right", "OptionArrowRight_TOP", 14);
	...
	option_images_[6] = new Revolution(game_manager_, "option_arrow_left", "OptionArrowLeft_TOP", 14);
	...
	option_images_[7] = new Revolution(game_manager_, "option_frame_slider", "OptionFrameSlider_DOWN", 13);
	...
	option_images_[8] = new Revolution(game_manager_, "option_arrow_right", "OptionArrowRight_DOWN", 14);
	...
	option_images_[9] = new Revolution(game_manager_, "option_arrow_left", "OptionArrowLeft_DOWN", 14);
	...
	option_ball_slider_bgm_ = new Revolution(game_manager_, "option_ball_slider", "option_ball_slider_top", 16);
	...
	option_stick_slider_bgm_ = new Revolution(game_manager_, "option_stick_slider", "option_stick_slider_top", 15);
	...
	option_ball_slider_se_ = new Revolution(game_manager_, "option_ball_slider", "option_ball_slider_down", 16);
	...
	option_stick_slider_se_ = new Revolution(game_manager_, "option_stick_slider", "option_stick_slider_down", 15);
...
void TitleScene::MoveSelect()
{
	...
	if (chapter_ < 0) chapter_ = CHAPTER_MAX;
